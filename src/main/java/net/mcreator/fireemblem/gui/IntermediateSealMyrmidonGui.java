...
public class IntermediateSealMyrmidonGui extends FireEmblemModElements.ModElement {
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			SetClassMercenaryProcedure.executeProcedure(ImmutableMap.<String, Object>builder().put("entity", entity).build());
		}
		if (buttonID == 1) {

			SetClassThiefProcedure.executeProcedure(ImmutableMap.<String, Object>builder().put("entity", entity).build());
		}
	}
