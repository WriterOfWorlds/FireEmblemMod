...
package net.mcreator.fireemblem.entity;
...
import net.mcreator.fireemblem.item.SilverAppleItem;
import net.mcreator.fireemblem.entity.renderer.PegasusRenderer;
import net.mcreator.fireemblem.FireEmblemModElements;

import java.util.Random;

@FireEmblemModElements.ModElement.Tag
public class PegasusEntity extends FireEmblemModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 2f))
					.build("pegasus").setRegistryName("pegasus");
	public PegasusEntity(FireEmblemModElements instance) {
		super(instance, 141);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PegasusRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("pegasus_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.horse.jump"));
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (SilverAppleItem.block == stack.getItem())
				return true;
			return false;
		}
