...
public class SilverAxeItem extends FireEmblemModElements.ModElement {
	@ObjectHolder("fire_emblem:silver_axe")
	public static final Item block = null;
	public SilverAxeItem(FireEmblemModElements instance) {
		super(instance, 56);
	}
