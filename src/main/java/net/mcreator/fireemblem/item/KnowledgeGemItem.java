...
public class KnowledgeGemItem extends FireEmblemModElements.ModElement {
	@ObjectHolder("fire_emblem:knowledge_gem")
	public static final Item block = null;
	public KnowledgeGemItem(FireEmblemModElements instance) {
		super(instance, 174);
	}
