...
public class IntermediateSealItem extends FireEmblemModElements.ModElement {
	@ObjectHolder("fire_emblem:intermediate_seal")
	public static final Item block = null;

	public IntermediateSealItem(FireEmblemModElements instance) {
		super(instance, 99);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("intermediate_seal");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			IntermediateSealUseProcedure.executeProcedure(
