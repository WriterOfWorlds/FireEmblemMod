...
public class SilverPickaxeItem extends FireEmblemModElements.ModElement {
	@ObjectHolder("fire_emblem:silver_pickaxe")
	public static final Item block = null;
	public SilverPickaxeItem(FireEmblemModElements instance) {
		super(instance, 55);
	}
