...
import net.mcreator.fireemblem.gui.IntermediateSealMyrmidonGui;
import net.mcreator.fireemblem.gui.IntermediateSealGUIGui;
...
public class IntermediateSealUseProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				FireEmblemMod.LOGGER.warn("Failed to load dependency y for procedure IntermediateSealUse!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				FireEmblemMod.LOGGER.warn("Failed to load dependency z for procedure IntermediateSealUse!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FireEmblemMod.LOGGER.warn("Failed to load dependency world for procedure IntermediateSealUse!");
			return;
		}
					...
					if (_ent instanceof ServerPlayerEntity) {
						...
						NetworkHooks.openGui((ServerPlayerEntity) _ent, new INamedContainerProvider() {
							...
							public ITextComponent getDisplayName() {
								return new StringTextComponent("IntermediateSealGUI");
							}

							@Override
							public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
								return new IntermediateSealGUIGui.GuiContainerMod(id, inventory,
				...
				((itemstack)).setCount((int) 0);
				{
					...
					if (_ent instanceof ServerPlayerEntity) {
						...
						NetworkHooks.openGui((ServerPlayerEntity) _ent, new INamedContainerProvider() {
							@Override
							public ITextComponent getDisplayName() {
								return new StringTextComponent("IntermediateSealMyrmidon");
							}

							@Override
							public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
								return new IntermediateSealMyrmidonGui.GuiContainerMod(id, inventory,
										new PacketBuffer(Unpooled.buffer()).writeBlockPos(_bpos));
							}
						}, _bpos);
					}
		...
		if (((((entity.getCapability(FireEmblemModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
				((PlayerEntity) entity).sendStatusMessage(new StringTextComponent("Pick a Beginner class to use this."), (true));
			}
		}
	}
}
